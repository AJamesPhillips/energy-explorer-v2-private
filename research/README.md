...
Interesting figure: Fig. 5. Marginal shares of different generation...
...
Includes image of number of LNG tanker deliveries avoided in 2030 by different measure
https://www.carbonbrief.org/analysis-why-clean-energy-will-cut-uk-gas-imports-by-more-than-north-sea-drilling/


## Power Grid

* Zonal pricing - dividing the UK into separate pricing zones.

> UK plans for its National Grid to be entirely run on renewable energy by 2035 but a huge connection backlog means that many clean energy projects must wait for over a decade to be connected.
https://www.sciencemuseumgroup.org.uk/our-work/sustainability-approach/climate-talks/how-solve-uks-power-grid-problem

> (paraphrased) Ocean winds paid £72,000 to not generate power from its wind farms during a half-hour period on 3 June
...
having a higher standing charge than urban and southern areas.
* Use of the word "lottery" suggests it is random but these are well known price
